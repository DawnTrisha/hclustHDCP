...
Now we note that we need to consider the following points while using the functions,
 ...
 - It is sufficient for the user to enter either the data matrix (X) or the distance matrix (D) along with the dimension (p) of the observations. In case user wants to enter both, then also the user needs the dimension of the observations.  
