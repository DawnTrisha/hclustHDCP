...
where $\|\,.\,\|$ denotes the usual Euclidean distance and $p$ is the dimension of the obsrvations. Using MADD distance to construct the distance matrix we obtain the following result,
