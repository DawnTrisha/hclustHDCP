...
Clearly clustering can used for change-point detection as illustrated through the above example. However, if instead of the previous example, if we consider that there 
